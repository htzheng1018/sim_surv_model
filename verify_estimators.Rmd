...
boot_ci = function(wt, data, t) {
  ...
  ci_km.boot = quantile(surv_km.boot, prob = c(0.025, 0.975))
  ci_cox.boot = quantile(surv_cox.boot, prob = c(0.025, 0.975))
  ci_two.boot = quantile(surv_two.boot, prob = c(0.025, 0.975))
  result = data.frame(km_low = ci_km.boot[1], km_up = ci_km.boot[2],
                      cox_low = ci_cox.boot[1], cox_up = ci_cox.boot[2],
                      two_low = ci_two.boot[1], two_up = ci_two.boot[2])
  return(result)
}
```
