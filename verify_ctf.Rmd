...
run_on_cluster(
  ...
  first = {
    ...
    sim %<>% set_script(function() {
      ...
      dat_two_trt = dat_phaseTwo[dat_phaseTwo$treat == 1, ] # treat = 1 for counterfactual estimators
      model_two = coxph(Surv(Y, delta) ~ X1 + X2, data = dat_two_trt, weights = ipw) # s = 0 in counterfactual estimators
      ...
      Q_est_two = surv_two(model_two, t, dat_two_trt)
