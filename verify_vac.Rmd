...
run_on_cluster(
  ...
  first = {
    ...
    sim %<>% set_script(function() {
      ...
      dat_two_plc = dat_phaseTwo[dat_phaseTwo$treat == 1, ] # treat = 1 in treatment group
      model_two = coxph(Surv(Y, delta) ~ X1 + X2 + S, data = dat_two_plc, weights = ipw) # s != 0 in treatment group
