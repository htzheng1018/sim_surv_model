...
This file try to verify the bias of Survival Function in placebo group, and the coverage of it using a Bootstrap method.
...
run_on_cluster(
  ...
  first = {
    ...
    sim %<>% set_script(function() {
      ...
      dat_two_plc = dat_phaseTwo[dat_phaseTwo$treat == 0, ]
      model_two = coxph(Surv(Y, delta) ~ X1 + X2, data = dat_two_plc, weights = ipw)
